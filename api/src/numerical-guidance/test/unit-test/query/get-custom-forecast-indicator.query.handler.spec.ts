...
import { GetCustomForecastIndicatorQuery } from 'src/numerical-guidance/application/query/get-custom-forecast-indicator/get-custom-forecast-indicator.query';
