...
import { GetFluctuatingIndicatorsWithoutCacheQueryHandler } from 'src/numerical-guidance/application/query/get-fluctuatingIndicator-without-cache/get-fluctuatingIndicator-without-cache.query.handler';
...
describe('FluctucatingIndicatorKrxAdapter', () => {
        ...
        GetFluctuatingIndicatorsWithoutCacheQueryHandler,
        {
          ...
          useValue: {
            loadFluctuatingIndicatorWithoutCache: jest.fn().mockImplementation(() => {
              const apiData = FluctuatingIndicatorsWithoutCacheDto.create(testData);
              return apiData;
            }),
          },
        },
  ...
  it('API 데이터롤 가져온다', async () => {
    // given
    const testQuery = new GetFluctuatingIndicatorsWithoutCacheQuery(5, '005930', 'KOSPI', 'testtype');
