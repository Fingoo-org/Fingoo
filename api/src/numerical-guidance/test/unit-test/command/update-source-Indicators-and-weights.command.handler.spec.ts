...
import { UpdateSourceIndicatorsAndWeightsCommandHandler } from 'src/numerical-guidance/application/command/update-source-indicators-and-weights/update-source-indicators-and-weights.command.handler';
...
import { UpdateSourceIndicatorsAndWeightsCommand } from 'src/numerical-guidance/application/command/update-source-indicators-and-weights/update-source-indicators-and-weights.command';
