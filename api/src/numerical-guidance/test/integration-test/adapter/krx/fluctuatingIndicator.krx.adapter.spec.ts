...
describe('FluctuatingIndicatorKrxAdapter', () => {
  ...
  it('외부 API 연동 테스트', async () => {
    // given
    await fluctuatingIndicatorKrxAdapter.loadFluctuatingIndicatorWithoutCache(5, '005930', 'KOSPI', 'testtype');

    // when
    const result = await fluctuatingIndicatorKrxAdapter.loadFluctuatingIndicatorWithoutCache(
      5,
      '005930',
      'KOSPI',
      'testtype',
