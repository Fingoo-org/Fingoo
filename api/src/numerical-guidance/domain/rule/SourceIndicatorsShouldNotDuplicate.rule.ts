...
export class SourceIndicatorsShouldNotDuplicateRule implements BusinessRule {
  constructor(private readonly sourceIndicatorIdsInformation: SourceIndicatorDtoType[]) {}
  ...
  private indicatorIdsSet(sourceIndicatorIdsAndWeights: SourceIndicatorDtoType[]) {
