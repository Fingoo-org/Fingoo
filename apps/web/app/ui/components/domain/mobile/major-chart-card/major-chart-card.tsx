...
import {
  useCountryMajorChartCard,
  useCountryMajorChartCardWithCountry,
} from '@/app/business/hooks/mobile/major-chart/use-major-chart-card-view-model.hook';
...
export default function MajorChartCard({ country }: { country: string }) {
  ...
  const { majorChartsWithCountry } = useCountryMajorChartCardWithCountry(country);

  return (
    <Carousel>
      <Pending isPending={isPending}>
        <CarouselContent>
          {majorCharts.map((group, index) => (
